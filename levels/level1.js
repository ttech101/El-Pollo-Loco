...
function initLevel() {
    ...
    level1 = new Level([
        ...
        [
            //  new BackgroundObjectLayer1('img/5_background/layers/air.png', -720 * 2),
            new BackgroundObjectLayer1('img/5_background/layers/3_third_layer/2.png', -720 * 2),
            //new BackgroundObjectLayer1('img/5_background/layers/air.png', -720),
            ...
            // new BackgroundObjectLayer1('img/5_background/layers/air.png', 720 * 3),
            new BackgroundObjectLayer1('img/5_background/layers/3_third_layer/2.png', 720 * 3),
            // new BackgroundObjectLayer1('img/5_background/layers/air.png', 720 * 4),
            new BackgroundObjectLayer1('img/5_background/layers/3_third_layer/1.png', 720 * 4),
            // new BackgroundObjectLayer1('img/5_background/layers/air.png', 720 * 5),
            new BackgroundObjectLayer1('img/5_background/layers/3_third_layer/2.png', 720 * 5),
            // new BackgroundObjectLayer1('img/5_background/layers/air.png', 720 * 6),
            new BackgroundObjectLayer1('img/5_background/layers/3_third_layer/1.png', 720 * 6),
            // new BackgroundObjectLayer1('img/5_background/layers/air.png', 720 * 7),
